...
SSH_SRC_FILE=./target/mod-marccat-1.1.0-SNAPSHOT.jar
...
ssh_itnet_deploy(){
  ...
  nohup echo "cd /usr/local/folio/data ; java -jar mod-marccat-1.1.0-SNAPSHOT.jar " | ssh -p ${SSH_PORT} folio@${SSH_HOST} &
}
ssh_itnet_deploy
