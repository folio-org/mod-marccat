...
public class SearchTest extends TestBase {
  ...
  public void getMergedSearch_return200Status() {
    ...
    given().param("qbib", "TI I promessi sposi").param("lang", "ita").headers(headers).when().get(url).then()
        .statusCode(200);
  }
  ...
  public void getMergedSearchWithAnyView_return200Status() {
    ...
    given().param("q", "AN 1").param("lang", "ita").param("view", 0).headers(headers).when().get(url).then()
        .statusCode(200);
  }
  ...
  public void getMergedSearchSortByTitle_return200Status() {
    ...
    given().param("qbib", "TI Devoto-Oli dei sinonimi e contrari").param("lang", "ita").param("sortBy", "4")
  ...
  public void getMergedSearchSortBySubject_return200Status() {
    ...
    given().param("qbib", "SU Manzoni, Alessandro, 1785-1873").param("lang", "ita").param("sortBy", "21")
        .headers(headers).when().get(url).then().statusCode(200);
  }
  ...
  public void getMergedSearchByOperatorAnd_return200Status() {
    ...
    given().param("qbib", "TI Devoto-Oli dei sinonimi e contrari AND LAN ita").param("lang", "ita").headers(headers)
  ...
  public void getMergedSearchForAuthority_return200Status() {
    ...
    given().param("qbib", "TI I promessi sposi").param("qauth", "TI I promessi sposi").param("lang", "ita")
        .param("view", -1).headers(headers).when().get(url).then().statusCode(200);
  }
  ...
  public void getSearch_return200Status() {
    ...
    given().param("q", "TI Storia").headers(headers).when().get(url).then().statusCode(200);
  }
  ...
  public void getSearchVertica_return200Statusl() {
    ...
    given().param("q", "TI I promessi sposi").param("lang", "ita").param("ml", "170").headers(headers).when().get(url)
        .then().statusCode(200);
  }
