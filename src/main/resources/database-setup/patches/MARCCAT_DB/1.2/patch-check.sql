...
DECLARE
  ...
  check_msg2 text;
BEGIN
  check_msg1 := 'Check MARCCAT DB version: ' || current_setting('myvars.patch_rel_nbr') || '.' || current_setting('myvars.patch_sp_nbr') || ' found.';
  check_msg2 := 'Check MARCCAT DB version: ' || current_setting('myvars.patch_rel_nbr') || '.' || current_setting('myvars.patch_sp_nbr') || ' not found.';
