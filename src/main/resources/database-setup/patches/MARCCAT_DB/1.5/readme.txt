...
DESCRIPTION
Installation script of the database component MARCCAT DB 1.5 to be included in the MARCcat release
...
INSTALLATION AND EXECUTION
 ...
 - There is a ckeck into this patch to prevent to be installed more times, so error such the
   one below is normal if more installation attempts are made:
     ...
     psql:patch-check.sql:21: ERROR:  Check MARCCAT DB version: 1.5 found.
