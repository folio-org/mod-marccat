CREATE OR REPLACE FUNCTION amicus.trigger_fct_publ_tag_d() RETURNS trigger AS 
$BODY$

/*****************************************************************************************
   NAME: AMICUS.trigger_fct_publ_tag_d
   PURPOSE: 
   REVISIONS:
   Ver    Date        Author           Description
   -----  ----------  ---------------  ---------------------------------------------------
   1.0    29/03/2019  Mirko Fonzo      Updates Full Text Index on PUBL_TAG table delete.
*****************************************************************************************/
...
DROP TRIGGER IF EXISTS publ_tag_d on AMICUS.publ_tag;

CREATE TRIGGER publ_tag_d
AFTER DELETE ON AMICUS.publ_tag FOR EACH ROW
EXECUTE PROCEDURE AMICUS.trigger_fct_publ_tag_d();
