...
import librisuite.hibernate.CollectionCustomer;
import librisuite.hibernate.CollectionCustomerArch;
...
import com.casalini.cataloguing.form.CollectionsCustomForm;
...
//			Query q = s.createQuery("select distinct ct from CollectionCustomer as ct "	+ ordinamento);
			...
			while (iter.hasNext()) {
				...
				rawCustomListElement.setNameIta(LibrisuiteAction.getDaoCodeTable().getLongText((short)rawCustom.getNameIta(),librisuite.hibernate.T_CLCTN_CST_TYP.class,locale));
				rawCustomListElement.setTypologyCode(LibrisuiteAction.getDaoCodeTable().getLongText(rawCustom.getTypologyCode(),librisuite.hibernate.T_CLCTN_TYP.class,locale));
				rawCustomListElement.setStatusCode(LibrisuiteAction.getDaoCodeTable().getLongText(rawCustom.getStatusCode().shortValue(),librisuite.hibernate.T_STS_CLCTN_TYP.class,locale));
