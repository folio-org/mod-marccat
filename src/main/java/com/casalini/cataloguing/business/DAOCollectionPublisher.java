...
{	
	...
	public List orderPubCollection(String colonna, String tipoOrdinamento,Locale locale) throws DataAccessException 
	{
		...
		try {
			...
			while (iter.hasNext()) {
				...
				rawMasterListElement.setNameIta(LibrisuiteAction.getDaoCodeTable().getLongText((short)rawMaster.getNameIta(),librisuite.hibernate.T_CLCTN_PUBL_TYP.class,locale));
				rawMasterListElement.setStatusCode(LibrisuiteAction.getDaoCodeTable().getLongText((short)rawMaster.getStatusCode(),librisuite.hibernate.T_STS_CLCTN_TYP.class,locale));
				rawMasterListElement.setPublCode(rawMaster.getPublCode());
				rawMasterListElement.setLevelCode(LibrisuiteAction.getDaoCodeTable().getLongText((short)rawMaster.getLevelCode(),librisuite.hibernate.T_CLCTN_PUBL_LVL_TYP.class,locale));
	...
	public List getListPublishersElement(Locale locale) throws DataAccessException 
	{
		...
		while (iter.hasNext()) {
			...
			rawPublisherListElement.setNameIta(LibrisuiteAction.getDaoCodeTable().getLongText((short)rawPublisher.getNameIta(),librisuite.hibernate.T_CLCTN_PUBL_TYP.class,locale));
			rawPublisherListElement.setPublCode(rawPublisher.getPublCode());
			rawPublisherListElement.setLevelCode(LibrisuiteAction.getDaoCodeTable().getLongText((short)rawPublisher.getLevelCode(),librisuite.hibernate.T_CLCTN_PUBL_LVL_TYP.class,locale));
			rawPublisherListElement.setStatusCode(LibrisuiteAction.getDaoCodeTable().getLongText((short)rawPublisher.getStatusCode(),librisuite.hibernate.T_STS_CLCTN_TYP.class,locale));
	...
	public List getListPublishersElementByLevelCode(String levelCode, String publisherCode, Locale locale) throws DataAccessException 
	{
		...
		while (iter.hasNext()) {
			...
			rawMasterListElement.setNameIta(LibrisuiteAction.getDaoCodeTable().getLongText((short)rawPublisher.getNameIta(),librisuite.hibernate.T_CLCTN_PUBL_TYP.class,locale));
			rawMasterListElement.setPublCode(rawPublisher.getPublCode());
			rawMasterListElement.setLevelCode(LibrisuiteAction.getDaoCodeTable().getLongText((short)rawPublisher.getLevelCode(),librisuite.hibernate.T_CLCTN_PUBL_LVL_TYP.class,locale));
			rawMasterListElement.setStatusCode(LibrisuiteAction.getDaoCodeTable().getLongText((short)rawPublisher.getStatusCode(),librisuite.hibernate.T_STS_CLCTN_TYP.class,locale));
			if(loadHRCY(rawPublisher.getIdCollection()).size()>0){
				rawMasterListElement.setHierarchy(true);
			}else{
				rawMasterListElement.setHierarchy(false);
