...
import librisuite.hibernate.CollectionMaster;
	...
	public List orderMstCollection(CollectionsMasterForm form, Locale locale) throws DataAccessException
	{
		...
		try {
			...
			while (iter.hasNext()) {
				...
				rawMasterListElement.setNameIta(LibrisuiteAction.getDaoCodeTable().getLongText((short)rawMaster.getNameIta(),librisuite.hibernate.T_CLCTN_MST_TYP.class,locale));
				...
				rawMasterListElement.setTypologyCode(LibrisuiteAction.getDaoCodeTable().getLongText(rawMaster.getTypologyCode(),librisuite.hibernate.T_CLCTN_TYP.class,locale));
