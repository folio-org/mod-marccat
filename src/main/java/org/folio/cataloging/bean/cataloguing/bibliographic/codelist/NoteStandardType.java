...
import org.folio.cataloging.dao.persistence.T_CAS_STND_NTE_TYP;
 ...
 * @since 1.0
 */
public class NoteStandardType extends CodeListBean {

	public NoteStandardType() {
		super(T_CAS_STND_NTE_TYP.class);
	}
