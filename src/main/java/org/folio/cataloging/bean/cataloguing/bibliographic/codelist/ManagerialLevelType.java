...
import org.folio.cataloging.dao.persistence.T_CAS_MNGRL_LVL_TYP;
 ...
 * @since 1.0
 */
public class ManagerialLevelType extends CodeListBean {

	public ManagerialLevelType() {
		super(T_CAS_MNGRL_LVL_TYP.class);
	}
