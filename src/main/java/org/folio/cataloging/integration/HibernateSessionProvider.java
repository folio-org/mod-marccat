...
{
    private final Log logger = new Log(HibernateSessionProvider.class);
 ...
 //   private static String datasource = Defaults.getString("hibernate.connection.datasource");
  ...
  /*  private static final ThreadLocal sessionHolder = new ThreadLocal();
            ...
            throws HibernateException
    {
        ...
        new InjectedDataSourceConnectionProvider();


        this.configuration.setProperty("hibernate.dialect", "net.sf.hibernate.dialect.PostgreSQLDialect");
        this.configuration.setProperty("dialect", "net.sf.hibernate.dialect.PostgreSQLDialect");
