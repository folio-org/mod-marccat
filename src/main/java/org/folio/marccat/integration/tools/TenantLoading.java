...
public class TenantLoading {
  ...
  private void loadDataAuthority(String okapiUrl, Map<String, String> headers) {
    ...
    String requestJson;
    try {
      requestJson = IOUtils.toString(this.getClass().getResourceAsStream("/sample-data/load-from-file/authority/name.json"),
      ...
      requestJson = IOUtils.toString(this.getClass().getResourceAsStream("/sample-data/load-from-file/authority/subject.json"),
          String.valueOf(StandardCharsets.UTF_8));
