...
public class SQLCommand {
  ...
  private static final String JOIN_AUT_T1_ON_T1_AUT_NBR_SMTC_AUT_NBR = "join aut t1 on t1.aut_nbr = smtc.aut_nbr";

  /**
   * build the query for the join of the title for the bibliographic
   */
  public static final String TITLE_JOIN = new StringBuilder()
   ...
   */
  public static final String UNIFORM_TITLE_JOIN = new StringBuilder()
    .append(" join ttl_acs_pnt t1 on t1.bib_itm_nbr = smtc.bib_itm_nbr ")
    .append(" join ttl_hdg t2 on t2.ttl_hdg_nbr = t1.ttl_hdg_nbr and t2.usr_vw_ind = t1.usr_vw_ind ")
   ...
   */
  public static final String NAME_JOIN = new StringBuilder()
    .append(" join nme_acs_pnt t1 on t1.bib_itm_nbr = smtc.bib_itm_nbr ")
    .append(" join nme_hdg t2 on t2.nme_hdg_nbr = t1.nme_hdg_nbr and t2.usr_vw_ind = t1.usr_vw_ind ").toString();

  /**
   * build the query for the join of the subject for the bibliographic
   */
  public static final String SUBJECT_JOIN = new StringBuilder()
   ...
   */
  public static final String DATE_JOIN = new StringBuilder()
   ...
   */
  public static final String TITLE_AUT_JOIN = new StringBuilder()
    .append(JOIN_AUT_T1_ON_T1_AUT_NBR_SMTC_AUT_NBR)
    .append(" join ttl_hdg t2 on t2.ttl_hdg_nbr = t1.hdg_nbr ").toString();
  /**
   * build the query for the join of the name for the authority
   */
  public static final String NME_AUT_JOIN = new StringBuilder()
    .append(JOIN_AUT_T1_ON_T1_AUT_NBR_SMTC_AUT_NBR)
   ...
   */
  public static final String SUBJECT_AUT_JOIN = new StringBuilder()
    .append(JOIN_AUT_T1_ON_T1_AUT_NBR_SMTC_AUT_NBR)
