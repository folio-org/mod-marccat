...
public class CLCTN_CST_ACS_PNT implements Persistence {
   ...
   * @since 1.0
   */
  public CLCTN_CST_ACS_PNT(int itemNumber, int collectionNumber, Date creationDate, Date transactionDate) {
    super();
  ...
  public boolean equals(Object arg0) {
    if (arg0 instanceof CLCTN_CST_ACS_PNT) {
      CLCTN_CST_ACS_PNT c = (CLCTN_CST_ACS_PNT) arg0;
