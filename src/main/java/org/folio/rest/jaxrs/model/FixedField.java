...
public class FixedField {
    ...
    public FixedField withDescription(String description) {
        this.description = description;
        return this;
    }
