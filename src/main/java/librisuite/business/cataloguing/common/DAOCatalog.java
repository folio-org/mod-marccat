...
import librisuite.business.cataloguing.authority.AuthorityNote;
import librisuite.business.cataloguing.authority.AuthorityReferenceTag;
...
public abstract class DAOCatalog extends HibernateUtil 
{
	private static Log logger = LogFactory.getLog(DAOCatalog.class);
...
//		insertDeleteTable(item, user);
	...
	protected void loadHeadings(List allTags, int userView) throws DataAccessException 
	{
