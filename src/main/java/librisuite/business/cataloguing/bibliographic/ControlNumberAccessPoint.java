...
import librisuite.hibernate.ControlNumberFunction;
import librisuite.hibernate.ControlNumberType;
...
public class ControlNumberAccessPoint extends BibliographicAccessPoint implements OrderedTag  {
	...
	/* (non-Javadoc)
	 * @see librisuite.business.cataloguing.bibliographic.AccessPoint#setAccesspointStringText(com.StringText)
	 */
