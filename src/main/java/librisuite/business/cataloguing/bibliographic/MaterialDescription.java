...
import librisuite.hibernate.RecordTypeMaterial;
...
public class MaterialDescription extends FixedFieldUsingItemEntity implements PersistentObjectWithView 
{
	...
	/* (non-Javadoc)
	 * @see librisuite.business.cataloguing.bibliographic.FixedField#setBibItm(librisuite.business.cataloguing.bibliographic.BIB_ITM)
	 */
	...
	/* (non-Javadoc)
	 * @see librisuite.business.cataloguing.bibliographic.FixedField#setBibHeader(short)
	 */
