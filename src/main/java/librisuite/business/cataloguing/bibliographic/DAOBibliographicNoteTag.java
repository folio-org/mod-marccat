...
import librisuite.hibernate.StandardNoteAccessPoint;
...
public class DAOBibliographicNoteTag extends HibernateUtil {
	...
	/* (non-Javadoc)
	 * @see com.HibernateUtil#save(librisuite.business.common.Persistence)
	 */
	...
	/* (non-Javadoc)
	 * @see com.HibernateUtil#update(librisuite.business.common.Persistence)
	 */
