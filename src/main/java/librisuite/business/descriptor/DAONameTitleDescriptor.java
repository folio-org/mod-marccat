...
public class DAONameTitleDescriptor extends DAODescriptor {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see librisuite.business.descriptor.DAODescriptor#getXrefCount(librisuite.business.descriptor.Descriptor,
	 *      int)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see librisuite.business.descriptor.DAODescriptor#getCrossReferences(librisuite.business.descriptor.Descriptor,
	 *      int)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see librisuite.business.descriptor.DAODescriptor#loadReference(librisuite.business.descriptor.Descriptor,
	 *      librisuite.business.descriptor.Descriptor, short, int)
	 */
