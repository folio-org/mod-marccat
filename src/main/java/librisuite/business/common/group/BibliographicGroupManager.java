...
import librisuite.business.common.filter.GroupTagFilter;
import librisuite.business.common.filter.NoTagFilter;
import librisuite.business.common.filter.SingleTagFilter;
...
public class BibliographicGroupManager extends MarcGroupManager implements FilterManager {
	...
	/* (non-Javadoc)
	 * @see librisuite.business.common.filter.FilterManager#getFilter(librisuite.business.cataloguing.common.Tag)
	 */
