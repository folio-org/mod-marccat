...
import com.casalini.digital.business.DAOCasSapPubl;
...
public class BrowseBean extends SearchBean {
	...
	{
		BrowseBean bean = (BrowseBean) BrowseBean.getSessionAttribute(request, BrowseBean.class);
		if (bean == null) {
			bean = new BrowseBean();
...
//-------->	201107 fine
	...
	{
		com.casalini.hibernate.model.CasSapPubl publisherDb = null; 
		String shortCode = "";
		for (int i = 0; i < publishers.size(); i++) {
			publisherDb = (com.casalini.hibernate.model.CasSapPubl)publishers.get(i);
