...
import librisuite.bean.cataloguing.heading.ShelfListHeadingBean;
...
import librisuite.business.exception.EmptySubfieldException;
import librisuite.business.exception.InvalidShelfListTypeException;
import librisuite.business.exception.LibrisuiteException;
import librisuite.business.exception.NoSubfieldCodeException;
...
import librisuite.hibernate.T_HLDG_LVL_OF_DTL;
import librisuite.hibernate.T_HLDG_SBCPT_STUS;
import librisuite.hibernate.T_HLDG_SRS_TRMT;
import librisuite.hibernate.T_HLDG_STUS_TYP;
import librisuite.hibernate.T_LOAN_PRD;
import librisuite.hibernate.T_SHLF_LIST_TYP;
import librisuite.hibernate.T_SRL_GENRETENTION;
...
public class CopyBean extends LibrisuiteBean {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see librisuite.bean.cataloguing.heading.HeadingBean#onPopulateLists(librisuite.business.codetable.DAOCodeTable,
	 *      java.util.Locale)
	 */
