package librisuite.bean.cataloguing.common;
...
import librisuite.bean.cataloguing.bibliographic.StringTextEditBeanForItemEditing;
...
import librisuite.bean.cataloguing.copy.OntologyTypeBean;
import librisuite.bean.searching.BibliographicTableManager;
import librisuite.bean.searching.ICodeTableManager;
...
import librisuite.business.cataloguing.bibliographic.ChangeFixedFieldCommand;
import librisuite.business.cataloguing.bibliographic.ChangeTextCommand;
import librisuite.business.cataloguing.bibliographic.ChangeValuesCommand;
import librisuite.business.cataloguing.bibliographic.ChangeValuesIndicatorCommand;
...
import librisuite.business.cataloguing.bibliographic.DAOBibliographicRelationship;
import librisuite.business.cataloguing.bibliographic.DeleteTagCommand;
...
import librisuite.business.cataloguing.bibliographic.NewTagCommand;
import librisuite.business.cataloguing.bibliographic.NewTagException;
import librisuite.business.cataloguing.bibliographic.ReplaceDescriptorCommand;
import librisuite.business.cataloguing.bibliographic.ReplaceTagCommand;
...
import librisuite.form.cataloguing.bibliographic.EditTagForm;
...
import librisuite.hibernate.T_AUT_HDG_SRC;
import librisuite.hibernate.T_SINGLE;
import librisuite.hibernate.T_SKP_IN_FLNG_CNT;
...
import com.casalini.digital.business.DigitalDoiException;
import com.casalini.digital.business.DigitalFileSystemException;
import com.casalini.digital.business.DigitalLevelException;
import com.casalini.digital.business.FileManagerDo;
...
public void saveAuthorityRecord() throws DataAccessException,
	...
	public short getSkipInFilingHeading() {
		...
		if (d instanceof librisuite.hibernate.TTL_HDG && !d.isNew())
			return ((librisuite.hibernate.TTL_HDG) d).getSkipInFiling();
		else
			return skipInFiling;
	}
